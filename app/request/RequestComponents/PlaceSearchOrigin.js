...
export default function PlaceSearchOrigin() {
  ...
  const [searchOriginLongitude, setearchOriginLongitude] = useState(null);
  const {
    ready,
    value,
  ...
  useEffect(() => {
    if (searchOriginLatitude && searchOriginLongitude) {
      console.log(
        `Retrieved ${searchOriginLatitude} and ${searchOriginLongitude}`
      );
    }
  }, [setsearchOriginLatitude, setearchOriginLongitude]);
